...
const whereEq = (matchAnnotations: AnnotationData) => (annotationsToCheck: AnnotationData): boolean =>
  Object.keys(matchAnnotations).every(annotation => matchAnnotations[annotation] === annotationsToCheck[annotation]);
