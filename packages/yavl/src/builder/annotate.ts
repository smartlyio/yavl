...
type EnsureValueIsOfAnnotationType<Value, AnnotationType> = ExtractDependencies<Value> extends AnnotationType
  ? unknown
  : never;

export interface AnnotateFn {
  <FieldType, AnnotationType, Value extends EnsureValueIsOfAnnotationType<Value, AnnotationType>>(
