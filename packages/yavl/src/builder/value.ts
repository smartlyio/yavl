...
import { ModelContext, SupportedDefinition, ValueOrContextOfType } from '../types';
import annotate from './annotate';

export interface ValueFn {
  <FieldType>(context: ModelContext<FieldType>, value: ValueOrContextOfType<FieldType>): SupportedDefinition;
}

const value: ValueFn = (context: ModelContext<any>, value: any): SupportedDefinition => {
  return annotate(
    /**
